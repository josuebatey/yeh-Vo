...
export function BoltBadge({ 
  ...
  // Mobile-specific positioning to avoid interference
  const mobilePositionClasses = {
    'top-right': 'top-20 right-4', // Below header
    'bottom-right': 'bottom-20 right-4', // Above potential navigation
    ...
    return (
      <a
        ...
        className={cn(
          ...
          'hover:bg-black/90 focus:outline-none focus:ring-2 focus:ring-white/20',
          // Desktop positioning
          `hidden md:flex items-center gap-1 ${positionClasses[position]}`,
          // Mobile positioning - more conservative
          `md:hidden ${mobilePositionClasses[position]}`,
          className
        )}
  ...
  return (
    <a
      ...
      rel="noopener noreferrer"
      className={cn(
        'fixed z-40 transition-all duration-300 hover:scale-110 active:scale-95',
        'focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-2',
        'rounded-full shadow-lg hover:shadow-xl',
        // Desktop positioning
        `hidden md:block ${positionClasses[position]}`,
        // Mobile positioning - ensure it doesn't interfere with other components
        `md:hidden ${mobilePositionClasses[position]}`,
        className
      )}
      aria-label="Built with Bolt.new"
    >
      <div className={cn(
        ...
        'hover:shadow-2xl',
        // Size adjustments for mobile vs desktop
        'w-12 h-12 md:w-14 md:h-14',
        variant === 'white' 
          ? 'bg-white/90 backdrop-blur-sm border border-gray-200/50 hover:bg-white' 
          : 'bg-black/90 backdrop-blur-sm border border-gray-800/50 hover:bg-black'
      )}>
        {/* Official Bolt.new SVG */}
