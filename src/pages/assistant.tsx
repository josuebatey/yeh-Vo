...
export function AIAssistant() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      type: 'assistant',
      content: 'Hello! I\'m your VoicePay AI assistant. I can help you with your wallet, transactions, and answer questions about your finances. What would you like to know?',
      timestamp: new Date()
    }
  ])
  ...
  const generateResponse = async (userInput: string): Promise<string> => {
    ...
    if (lowerInput.includes('invest') || lowerInput.includes('returns')) {
      return 'VoicePay offers investment opportunities with different risk levels: Conservative (5.5% APY), Balanced (8.5% APY), and Growth (12% APY). You can start investing from the Investment page.'
    }
    
    // How to send money
    if (lowerInput.includes('send') || lowerInput.includes('payment')) {
      return 'To send money, you can: 1) Use voice commands like "Send 10 dollars to Alice", 2) Use the Send Payment page, or 3) Scan a QR code. VoicePay supports Algorand blockchain, mobile money, and bank transfers.'
    }
    
    // Security
    if (lowerInput.includes('security') || lowerInput.includes('safe')) {
      return 'VoicePay uses bank-level security with encrypted wallets and Supabase authentication. Your recovery phrase is securely stored and only you can access it. This is currently running on Algorand TestNet for demonstration.'
    }
    ...
    // Default response
    return 'I understand you\'re asking about VoicePay. I can help with wallet information, sending payments, investments, and voice commands. Could you be more specific about what you\'d like to know?'
  }
